...
// logic of moving bricks is taken from online course of c# games on website http//:videosharp.info
namespace Tetris
{
    public partial class Tetris : Form
    {
        ...
        public void DrawMap(Graphics g)
        {
            for(int i = 0; i <= 16; i++)
            {
                g.DrawLine(Pens.Black, new Point(50, 50 + i * size), new Point(50 + 8 * size+1, 50 + i *size));
            }
            for (int i = 0; i <= 8; i++)
            {
